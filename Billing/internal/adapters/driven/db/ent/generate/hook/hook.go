...
type InvoiceFunc func(context.Context, *generate.InvoiceMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f InvoiceFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.InvoiceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.InvoiceMutation", m)
}

// The PlanFunc type is an adapter to allow the use of ordinary
// function as Plan mutator.
type PlanFunc func(context.Context, *generate.PlanMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f PlanFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.PlanMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.PlanMutation", m)
}

// The SubscriptionFunc type is an adapter to allow the use of ordinary
// function as Subscription mutator.
type SubscriptionFunc func(context.Context, *generate.SubscriptionMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f SubscriptionFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.SubscriptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.SubscriptionMutation", m)
}
