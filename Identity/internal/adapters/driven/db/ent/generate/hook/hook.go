...
type DomainFunc func(context.Context, *generate.DomainMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f DomainFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.DomainMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.DomainMutation", m)
}
...
type TenantFunc func(context.Context, *generate.TenantMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f TenantFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.TenantMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.TenantMutation", m)
}

// The TenantMemberFunc type is an adapter to allow the use of ordinary
// function as TenantMember mutator.
type TenantMemberFunc func(context.Context, *generate.TenantMemberMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f TenantMemberFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.TenantMemberMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.TenantMemberMutation", m)
}
