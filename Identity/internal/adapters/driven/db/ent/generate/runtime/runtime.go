...
import (
	...
	"go-link/identity/internal/adapters/driven/db/ent/schema"
	"time"
)
...
func init() {
	...
	domainDescCreatedAt := domainMixinFields0[0].Descriptor()
	...
	domainDescUpdatedAt := domainMixinFields0[1].Descriptor()
	...
	domainDescDomain := domainFields[0].Descriptor()
	...
	// domainDescIsVerified is the schema descriptor for is_verified field.
	domainDescIsVerified := domainFields[2].Descriptor()
	// domain.DefaultIsVerified holds the default value on creation for the is_verified field.
	domain.DefaultIsVerified = domainDescIsVerified.Default.(bool)
	...
	tenantmemberMixinInters1 := tenantmemberMixin[1].Interceptors()
	tenantmember.Interceptors[0] = tenantmemberMixinInters1[0]
	tenantmemberMixinFields0 := tenantmemberMixin[0].Fields()
	_ = tenantmemberMixinFields0
	...
	tenantmemberDescCreatedAt := tenantmemberMixinFields0[0].Descriptor()
	...
	tenantmemberDescUpdatedAt := tenantmemberMixinFields0[1].Descriptor()
