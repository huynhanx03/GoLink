...
import (
	...
	"go-link/identity/internal/adapters/driven/db/ent/generate/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.AttributeDefinition, c.Credential, c.Domain, c.FederatedIdentity,
		c.Permission, c.Resource, c.Role, c.Tenant, c.TenantMember, c.User,
		c.UserAttributeValue,
	} {
		n.Use(hooks...)
	}
}
...
func (c *DomainClient) QueryTenant(_m *Domain) *TenantQuery {
...
func (c *DomainClient) mutate(ctx context.Context, m *DomainMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("generate: unknown Domain mutation op: %q", m.Op())
	}
}
...
// QueryTenantMembers queries the tenant_members edge of a Role.
func (c *RoleClient) QueryTenantMembers(_m *Role) *TenantMemberQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, role.TenantMembersTable, role.TenantMembersColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryTenantMembers queries the tenant_members edge of a Tenant.
func (c *TenantClient) QueryTenantMembers(_m *Tenant) *TenantMemberQuery {
	query := (&TenantMemberClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(tenantmember.Table, tenantmember.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, tenant.TenantMembersTable, tenant.TenantMembersColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *TenantClient) QueryDomains(_m *Tenant) *DomainQuery {
...
func (c *TenantClient) mutate(ctx context.Context, m *TenantMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("generate: unknown Tenant mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *TenantMemberClient) UpdateOneID(id int) *TenantMemberUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *TenantMemberClient) DeleteOneID(id int) *TenantMemberDeleteOne {
...
func (c *TenantMemberClient) Get(ctx context.Context, id int) (*TenantMember, error) {
	return c.Query().Where(tenantmember.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TenantMemberClient) GetX(ctx context.Context, id int) *TenantMember {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryRole queries the role edge of a TenantMember.
func (c *TenantMemberClient) QueryRole(_m *TenantMember) *RoleQuery {
	query := (&RoleClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *TenantMemberClient) Hooks() []Hook {
	hooks := c.hooks.TenantMember
	return append(hooks[:len(hooks):len(hooks)], tenantmember.Hooks[:]...)
}

// Interceptors returns the client interceptors.
func (c *TenantMemberClient) Interceptors() []Interceptor {
	inters := c.inters.TenantMember
	return append(inters[:len(inters):len(inters)], tenantmember.Interceptors[:]...)
}
...
func (c *TenantMemberClient) mutate(ctx context.Context, m *TenantMemberMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("generate: unknown TenantMember mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		AttributeDefinition, Credential, Domain, FederatedIdentity, Permission,
		Resource, Role, Tenant, TenantMember, User, UserAttributeValue []ent.Hook
	}
	inters struct {
		AttributeDefinition, Credential, Domain, FederatedIdentity, Permission,
		Resource, Role, Tenant, TenantMember, User,
