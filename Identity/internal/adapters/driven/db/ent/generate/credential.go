...
func (*Credential) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case credential.FieldCredentialData:
			values[i] = new([]byte)
		case credential.FieldID, credential.FieldDeletedBy, credential.FieldUserID:
...
func (_m *Credential) Unwrap() *Credential {
	...
	if !ok {
		panic("generate: Credential is not a transactional entity")
	}
...
func (_m *Credential) GetID() int {
	return _m.ID
}

func (_m *Credential) SetID(id int) {
	_m.ID = id
}
