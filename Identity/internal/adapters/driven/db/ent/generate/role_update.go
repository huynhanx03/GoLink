...
func (_u *RoleUpdate) AddTenantMemberIDs(ids ...int) *RoleUpdate {
	_u.mutation.AddTenantMemberIDs(ids...)
	return _u
}

// AddTenantMembers adds the "tenant_members" edges to the TenantMember entity.
func (_u *RoleUpdate) AddTenantMembers(v ...*TenantMember) *RoleUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *RoleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.TenantMembersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.TenantMembersTable,
			Columns: []string{role.TenantMembersColumn},
			Bidi:    false,
...
// AddTenantMemberIDs adds the "tenant_members" edge to the TenantMember entity by IDs.
func (_u *RoleUpdateOne) AddTenantMemberIDs(ids ...int) *RoleUpdateOne {
	_u.mutation.AddTenantMemberIDs(ids...)
	return _u
}

// AddTenantMembers adds the "tenant_members" edges to the TenantMember entity.
func (_u *RoleUpdateOne) AddTenantMembers(v ...*TenantMember) *RoleUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearTenantMembers clears all "tenant_members" edges to the TenantMember entity.
func (_u *RoleUpdateOne) ClearTenantMembers() *RoleUpdateOne {
	_u.mutation.ClearTenantMembers()
	return _u
}

// RemoveTenantMemberIDs removes the "tenant_members" edge to TenantMember entities by IDs.
func (_u *RoleUpdateOne) RemoveTenantMemberIDs(ids ...int) *RoleUpdateOne {
	_u.mutation.RemoveTenantMemberIDs(ids...)
	return _u
}

// RemoveTenantMembers removes "tenant_members" edges to TenantMember entities.
func (_u *RoleUpdateOne) RemoveTenantMembers(v ...*TenantMember) *RoleUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
