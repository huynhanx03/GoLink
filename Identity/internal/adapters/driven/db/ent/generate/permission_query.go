...
func (_q *PermissionQuery) QueryRole() *RoleQuery {
...
func (_q *PermissionQuery) QueryResource() *ResourceQuery {
...
func (_q *PermissionQuery) WithRole(opts ...func(*RoleQuery)) *PermissionQuery {
	query := (&RoleClient{config: _q.config}).Query()
...
func (_q *PermissionQuery) WithResource(opts ...func(*ResourceQuery)) *PermissionQuery {
	query := (&ResourceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Permission, error) {
	...
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *Permission, e *Role) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *PermissionQuery) loadRole(ctx context.Context, query *RoleQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Role)) error {
...
func (_q *PermissionQuery) loadResource(ctx context.Context, query *ResourceQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Resource)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Permission)
	for i := range nodes {
