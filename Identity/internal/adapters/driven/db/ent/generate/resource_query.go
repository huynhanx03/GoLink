...
func (_q *ResourceQuery) QueryPermissions() *PermissionQuery {
...
func (_q *ResourceQuery) WithPermissions(opts ...func(*PermissionQuery)) *ResourceQuery {
	query := (&PermissionClient{config: _q.config}).Query()
...
func (_q *ResourceQuery) loadPermissions(ctx context.Context, query *PermissionQuery, nodes []*Resource, init func(*Resource), assign func(*Resource, *Permission)) error {
