...
func (_c *UserCreate) AddTenantMemberIDs(ids ...int) *UserCreate {
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.IsAdmin(); !ok {
		return &ValidationError{Name: "is_admin", err: errors.New(`generate: missing required field "User.is_admin"`)}
	}
	return nil
}
