...
func (_u *UserUpdate) AddTenantMemberIDs(ids ...int) *UserUpdate {
...
func (_u *UserUpdate) RemoveTenantMemberIDs(ids ...int) *UserUpdate {
...
// AddTenantMemberIDs adds the "tenant_members" edge to the TenantMember entity by IDs.
func (_u *UserUpdateOne) AddTenantMemberIDs(ids ...int) *UserUpdateOne {
	_u.mutation.AddTenantMemberIDs(ids...)
	return _u
}
...
// RemoveTenantMemberIDs removes the "tenant_members" edge to TenantMember entities by IDs.
func (_u *UserUpdateOne) RemoveTenantMemberIDs(ids ...int) *UserUpdateOne {
	_u.mutation.RemoveTenantMemberIDs(ids...)
	return _u
}
